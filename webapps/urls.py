...
urlpatterns = [
    ...
    path('new_random_segment', views.ajax_new_random_segment, name='new_random_segment'), 
    path('delete_segment', views.ajax_delete_segment, name='delete_segment'),
    path('undo_segment', views.ajax_undo_segment, name='undo_segment'),
    ...
    path('reset_segments', views.ajax_reset_segments, name='reset_segments'),
    path('reset_segments_chain', views.ajax_reset_segments_chain, name='reset_segments_chain'),
    path('generate_segment', views.ajax_generate_segment, name='generate_segment'),
    path('get_new_passwords', views.ajax_get_new_passwords, name='get_new_passwords'),
    path('get_more_passwords', views.ajax_get_more_passwords, name='get_more_passwords'),
    path('edit_segment', views.ajax_edit_segment, name='edit_segment'),
    ...
    path('new_segments1', views.new_segments1, name='new_segments1'),
